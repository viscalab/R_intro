...
* Now, create a chunk below. To do so, you need to place the cursor below these lines and press the green square with a "C" and a plus. 
...
In order to be able to use a package we need to install it. 
...
To be able to use a package we need to load it. To load a package we need the function "library":
